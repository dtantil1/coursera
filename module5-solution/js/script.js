...
function buildAndShowAboutHTML(aboutViewHtml) {
  ...
  for (let i = 1; i <= 5; i++) {
    ...
    console.log(stars);
    aboutViewHtml = insertProperty(aboutViewHtml, "star" + i, stars);
  }
    // add rating text to span
    aboutViewHtml = insertProperty(aboutViewHtml, "ratingText", rating);
